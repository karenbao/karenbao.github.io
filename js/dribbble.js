  ...
  success: function(data) {  
    if (data.length > 0) {
      ...
      $.each(sortedData.reverse(), function(i, val) {
        if(i === 0 ) {
          $('#leftShot').append('<div class="leftshot col-md-12" target="_blank" href="'+val.html_url +'" title="' + val.title + '"><video autoplay loop name="media" width="100%" height="100%"><source src="'+ val.video.url +'" type="video/mp4"></video></div>')
        } else if(i >= 5) {
